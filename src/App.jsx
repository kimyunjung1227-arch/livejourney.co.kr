...
import TitlePreviewScreen from './pages/TitlePreviewScreen'
import TitlePostsScreen from './pages/TitlePostsScreen'
        ...
        <div className="app-container">
          ...
          <div className="page-wrapper">
            <Routes>
              ...
              <Route path="/title-preview" element={<TitlePreviewScreen />} />
              <Route path="/title-posts" element={<ProtectedRoute><TitlePostsScreen /></ProtectedRoute>} />
