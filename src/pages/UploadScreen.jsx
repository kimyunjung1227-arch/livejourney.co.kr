      ...
      try {
        ...
        if (result.success) {
          ...
          setTimeout(() => {
            ...
            const earnedTitle = checkAndAwardTitles(currentUserId);
            if (earnedTitle) {
        ...
        setTimeout(() => {
          ...
          const currentUserId = user?.id || savedUser?.id || 'test_user_001';
          const earnedTitleResult = checkAndAwardTitles(currentUserId);
          ...
          // 타이틀과 뱃지가 모두 없으면 메인으로 이동
          if (!earnedBadge && !earnedTitleResult) {
            console.log('Navigate to main in 2 seconds...');
            setTimeout(() => {
              setShowSuccessModal(false);
              navigate('/main');
            ...
            <div className="w-full max-w-sm transform rounded-3xl bg-background-light dark:bg-card-dark p-8 shadow-2xl border-4 border-primary animate-scale-up">
              ...
              <div className="space-y-3">
                ...
                <button
                  ...
                  className="w-full bg-subtle-light dark:bg-subtle-dark text-text-primary-light dark:text-text-primary-dark py-4 rounded-xl font-bold hover:bg-border-light dark:hover:bg-border-dark transition-all"
                >
                  계속하기
                </button>
              </div>
