  ...
  return (
    <div className="flex h-full w-full flex-col bg-background-light dark:bg-background-dark group/design-root">
      <div className="flex-1 overflow-y-auto overflow-x-hidden">
        ...
        <h1 className="text-lg font-bold leading-tight tracking-[-0.015em] text-content-light dark:text-content-dark font-display">서비스 이용 약관</h1>
        ...
        <div className="p-6 space-y-6">
          {/* 제1조 */}
          <div className="space-y-4 text-content-light dark:text-content-dark">
            <h2 className="text-xl font-bold">제1조 (목적)</h2>
            <p className="text-sm leading-relaxed text-content-light/90 dark:text-content-dark/90">
          ...
          {/* 제3조 */}
          <div className="space-y-4 text-content-light dark:text-content-dark">
            <h2 className="text-xl font-bold">제3조 (약관 등의 명시와 설명 및 개정)</h2>
            <p className="text-sm leading-relaxed text-content-light/90 dark:text-content-dark/90">
          ...
          <div className="pt-6 pb-2">
            <p className="text-xs text-subtle-light dark:text-subtle-dark">시행일자: 2023년 10월 26일</p>
          </div>
        </div>
        </main>
      </div>
