  ...
  return (
    <div className="flex h-screen w-full flex-col bg-background-light dark:bg-background-dark group/design-root overflow-hidden">
      <div className="flex-1 overflow-y-auto overflow-x-hidden relative">
            ...
            <section className="bg-surface-light dark:bg-surface-dark px-4 py-8">
              ...
              <div className="mt-6 flex flex-col gap-6">
                ...
                <div>
                  ...
                  <select
                    className="custom-select block w-full rounded-lg border border-gray-300 bg-surface-subtle-light p-3 text-base text-black placeholder:text-gray-400 focus:border-primary focus:ring-primary dark:border-gray-500 dark:bg-surface-subtle-dark dark:text-white dark:placeholder:text-gray-500"
                    id="inquiry-type"
                    value={inquiryType}
                ...
                <div>
                  ...
                  <input
                    className="block w-full rounded-lg border border-gray-300 bg-surface-subtle-light p-3 text-base text-black placeholder:text-gray-400 focus:border-primary focus:ring-primary dark:border-gray-500 dark:bg-surface-subtle-dark dark:text-white dark:placeholder:text-gray-500"
                    id="title"
                ...
                <div>
                  ...
                  <textarea
                    ref={textareaRef}
                    className="block w-full resize-none rounded-lg border border-gray-300 bg-surface-subtle-light p-3 text-base text-black placeholder:text-gray-400 focus:border-primary focus:ring-primary dark:border-gray-500 dark:bg-surface-subtle-dark dark:text-white dark:placeholder:text-gray-500 min-h-[80px] overflow-hidden"
                    id="content"
                ...
                <div>
                  ...
                  />
                  {selectedFile ? (
                    <div className="flex w-full items-center justify-between rounded-lg border border-gray-300 bg-surface-subtle-light px-4 py-3 dark:border-gray-500 dark:bg-surface-subtle-dark">
                      <div className="flex items-center gap-2 overflow-hidden">
                        <span className="material-symbols-outlined text-lg text-primary">description</span>
                        <span className="truncate text-base text-black dark:text-white">{selectedFile.name}</span>
                      ...
                      <button
                        ...
                        className="flex h-6 w-6 items-center justify-center rounded-full hover:bg-gray-200 dark:hover:bg-gray-600"
                      >
                    ...
                    <button
                      ...
                      className="flex w-full items-center justify-center gap-2 rounded-lg border border-gray-300 bg-surface-light px-4 py-3 text-base font-medium text-black dark:border-gray-500 dark:bg-surface-dark dark:text-white hover:bg-surface-subtle-light dark:hover:bg-surface-subtle-dark transition-colors"
                    >
        ...
        {/* 문의 접수 버튼 */}
        <div className="flex-shrink-0 bg-surface-light p-4 dark:bg-surface-dark border-t border-border-light dark:border-border-dark pb-24">
          <button
            onClick={handleSubmit}
            disabled={!isFormValid()}
            className={`w-full rounded-full py-4 text-base font-bold text-white transition-colors ${isFormValid()
